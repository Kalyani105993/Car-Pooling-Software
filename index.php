                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black">CarPooling Software</h1>
                            <p class="intro-text">
                                Online CarPooling Software
                            </p>
...
<h1> No cars available :( </h1>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> CarPooling Software</h5>
                </div>
